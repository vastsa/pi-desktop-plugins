...
const english: SiteCopy = {
  ...
  categories: {
    ...
    theme: { label: "Themes", description: "Visual styles for your PI-Desktop workspace." },
...
const simplifiedChinese: SiteCopy = {
  ...
  categories: { all: { label: "全部插件", description: "目录中的全部插件。" }, productivity: { label: "效率工具", description: "让工作持续推进的小工具。" }, "developer-tools": { label: "开发工具", description: "检查、修改和理解你的代码库。" }, theme: { label: "主题", description: "为 PI-Desktop 工作区提供视觉风格。" }, community: { label: "社区插件", description: "由 PI-Desktop 社区构建的插件。" }, official: { label: "官方插件", description: "维护在官方插件目录中。" }, template: { label: "模板", description: "开发自己插件的起点。" } },
