...
(function (root, factory) {
  ...
  const DICT = {
    en: {
      ...
      "importer.importDone.done": "— grouped under their project; open the project or check the Projects page to view",
    ...
    "zh-CN": {
      ...
      "importer.importDone.done": "——已按项目归组；打开对应项目或在「项目」页查看",
