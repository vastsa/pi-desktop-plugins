...
const STRINGS = {
  en: {
    ...
    runOnce: "Run once",
    allowDestructive: "Allow this blocked command for this run",
    allowDestructiveHint: "Only a checked box in this management panel authorizes it. AI cannot override the guard.",
  ...
  "zh-CN": {
    ...
    runCommand: "执行命令",
    runOnce: "执行一次",
    allowDestructive: "本次允许执行被拦截的危险指令",
    allowDestructiveHint: "只有管理面板勾选才会放行，AI 不能代替确认。",
    quickCommands: "快捷命令",
    systemInfo: "系统信息",
    uptime: "运行时间",
    disk: "磁盘用量",
